...
export default function StudentRegistrationPage() {
  ...
  const studentNumber = 'SMS-2025-0009';
      ...
      <div className="page-container">
        ...
        <form onSubmit={handleSubmit} className="glass-card-subtle p-6 md:p-8">
          ...
          <div className="mb-6 p-4 bg-muted/50 rounded-xl">
            ...
            <p className="text-lg font-semibold font-mono text-primary mt-1">{studentNumber}</p>
          </div>
        ...
        <Dialog open={showSuccess} onOpenChange={setShowSuccess}>
          <DialogContent className="glass-card-subtle text-center sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Student <span className="font-semibold text-foreground">{firstName} {lastName}</span> has been registered with student number <span className="font-mono font-semibold text-primary">{studentNumber}</span>.
              </DialogDescription>
            </DialogHeader>
